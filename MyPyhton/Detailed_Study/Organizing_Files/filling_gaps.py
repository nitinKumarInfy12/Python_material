...
folder = 'C:\\Users\\kumar\\OneDrive\\Desktop\\Study Material\\Pyhton\\Python_Study\\Python_youtube\\Test'
...
for number in range(1, len(found) + 1):
    ...
    #zeroes = (num_length - len(str(number)))

    # Recreate path of what should be the next file
    current_file = '{}/{}{}{}'.format(folder, prefix,
                                        number, extension)
    ...
    if os.path.exists(current_file) is False:
        ...
        #next_zeroes = (num_length - len(str(next_num)))
        next_file = (folder + '\\' + prefix
...
# corrct the code for teh last file